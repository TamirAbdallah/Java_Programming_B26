...
public class TypeCasting {
    public static void main(String[] args) {
     ...
     long l1 = i3; // int is smaller than long, so it will automatically cast
        ...
        long l2 = 200;
        int i4 = (int) l2; // i'm trying to go from long int. long is bigger than int, so i must cast it

        long l3 = 10000000000000L;
        double d = 50;
        int i5 = (int)d; // trying to go from double type int typ.
        // double is bigger , so i need to cast
