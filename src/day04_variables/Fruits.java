...
public class Fruits {
    public static void main(String[] args) {
        ...
        apples = 45; // reassigning apple to have value of 25
        System.out.println("Apples after selling;" + apples);

        int price = 15;

       //System.out.println("Th e price of my 25 apples is $ 20"); hard coded
       System.out.println("Th e price of my " + apples +  "apples is $" + price);
